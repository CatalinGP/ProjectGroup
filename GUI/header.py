...
class Header(ttk.LabelFrame):
    def __init__(self, master, sign_out_func=None, user_type="guest", username=""):
    ...
    def update_status(self):
        ...
        status_text = f" Logged as {username} {'🔒' if user_type == 'admin' else '🔓'}"
        self.user_status_label.config(text=status_text)

    def set_user(self, username, user_type):
