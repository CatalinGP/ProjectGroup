...
def update_vm_config(vm_name_entry, vm_ram_entry, vm_cpu_count_entry, disk_size_entry, host_entry, port_entry, vm_configs_dict, ssh_config_dict, current_values_frame):
